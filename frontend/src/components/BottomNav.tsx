        ...
        {navItems.map((item) => {
          ...
          return (
            <button
              ...
              className={`flex flex-col items-center justify-center min-w-[58px] min-h-[48px] py-1 px-2.5 rounded-2xl transition-all cursor-pointer relative ${
                isActive
            ...
            >
              {isActive && (
                <span className="absolute -top-1 w-7 h-1 bg-[#3e90ff] rounded-full shadow-[0_0_8px_#3e90ff]" />
              )}
              <span
              ...
              <span className="text-[11px] leading-tight font-semibold tracking-tight mt-0.5">
                {item.label}
              </span>
            </button>
          );
